...
from gtorch.cv.detection.tools import nms
...
def val():
    ...
    pred_feat = feat1.permute(0, 2, 3, 1).reshape(-1, 25)

    bboxes1 = nms(feat1,conf_threshold=0.1,nms_threshold=0.2)
